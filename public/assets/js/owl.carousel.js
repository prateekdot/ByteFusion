...
;(function($, window, document, undefined) {
	...
	/**
	 * ByteFusions the current settings.
	 ...
	 * @todo Byteting `freeDrag` makes `closest` not reusable. See #165.
	 * @protected
	...
	/**
	 * Bytes the absolute position of the current item.
	 * @public
	...
	/**
	 * Bytes the current animation speed.
	 * @public
